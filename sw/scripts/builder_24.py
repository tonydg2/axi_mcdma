...
workspacePath = "../workspace_24c"
sourceDir = "../src"
client.set_workspace(path=workspacePath)

platform = client.create_platform_component(name = "u96_platform",hw_design = "../../output_products/top_bd_wrapper.xsa",os = "standalone",cpu = "psu_cortexa53_0",domain_name = "standalone_psu_cortexa53_0")
